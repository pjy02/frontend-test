...
function Sidebar({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "relative w-(--sidebar-width) bg-transparent transition-[width] duration-[var(--motion-duration-normal)] ease-[var(--motion-ease-standard)]",
      ...
      <div
        className={cn(
          "fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-[left,right,width] duration-[var(--motion-duration-normal)] ease-[var(--motion-ease-standard)] md:flex",
          side === "left"
