...
export default function PaymentForm<T extends { platform?: string }>({
  ...
  return (
    <DetailSheet
      description={t(
        "formDescription",
        "Configure provider credentials, callback behavior, fees, and customer-facing details."
      )}
      footer={
        <StickyActions
          description={t(
            "saveHint",
            "Verify provider credentials and callback domains before enabling this method."
          )}
        >
            ...
            {feeMode === 1 && (
              <div className="grid grid-cols-1 sm:w-1/2">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>{t("feePercent", "Fee Percentage")}</FormLabel>
                      <FormControl>
                        <EnhancedInput
            ...
            {feeMode === 2 && (
              <div className="grid grid-cols-1 sm:w-1/2">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>{t("feeAmount", "Fixed Amount")}</FormLabel>
                      <FormControl>
                        <EnhancedInput
                          onValueChange={(value) =>
                            field.onChange(
                  ...
                  <FormItem>
                    ...
                    >
                      <FormControl>
                        <SelectTrigger>
                          <SelectValue
                            placeholder={t("selectPlatform", "Select Platform")}
                          />
                        </SelectTrigger>
                      </FormControl>
                      <SelectContent>
