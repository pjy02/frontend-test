    ...
    <main className="min-h-screen bg-background">
      <div className="container py-6 sm:py-10">
          ...
          <div className="relative flex flex-col gap-7 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-3xl">
              <div className="mb-5 flex items-center gap-2">
                ...
                <Badge variant="secondary">Design System · Phase 1–5</Badge>
              </div>
        ...
        <footer className="mt-12 flex flex-col gap-2 border-t py-8 text-muted-foreground text-xs sm:flex-row sm:items-center sm:justify-between">
          <span>Perfect Panel Design System · Phase 1–5</span>
          <span>
            Foundation · Shell · Page Patterns · Vertical & Business Templates
          </span>
        </footer>
      </div>
    </main>
